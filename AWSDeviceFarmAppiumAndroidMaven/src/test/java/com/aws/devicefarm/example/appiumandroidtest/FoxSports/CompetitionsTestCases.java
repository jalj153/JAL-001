...
public class CompetitionsTestCases {
	...
	public void Competitions_010(){
		System.out.println("Voy a verificar que las competencias existan y que pertenezcan a un pais especifico");
	...
	public void Competitions_020(){
		System.out.println("Voy a buscar la competencia La Liga");
		competitionsSteps.tapCompetitions();//Tap in competitions
		competitionsSteps.tapInSearch();//find the button Search
		competitionsSteps.sendText();//Find competition La Liga
		Tools.backToMenu(2);
		
	}
	public void Competitions_030(){
		System.out.println("Voy a entrar en la competencia La Liga y verificar que esten todos los tabs");
		competitionsSteps.tapCompetitions();//Tap in competitions
		competitionsSteps.tapInSearch();
	...
	public void Competitions_040(){
		System.out.println("Mostrare los resultados de una liga");
	...
	public void Competitions_050(){
		System.out.println("Entrare a un resultado de la liga");
		competitionsSteps.tapCompetitions();
	...
	public void Competitions_060(){//buscar resumen
		System.out.println("Entrare al resumen de un partido");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_070(){
		System.out.println("Entrare a la linea de tiempo de un partido ");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_080(){
		System.out.println("Entrare a las estadisticas de un partido");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_090(){
		System.out.println("Entrare a las alineaciones");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_100(){
		System.out.println("Entrare al historial");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_110(){
		System.out.println("Entrare a la clasificacion");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchResults();
		competitionsSteps.tapResult();//Tap in a result
	...
	public void Competitions_120(){
		System.out.println("Entrare a la seccion noticias de una competencia");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
	...
	public void Competitions_130(){
		System.out.println("Entrare a la seccion posiciones");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
	...
	public void Competitions_140(){
		System.out.println("Entrare a ver los equipos de la competencia");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
	...
	public void Competitions_150(){
		System.out.println("Verificare que un equipo tenga los tabs correctos");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
		competitionsSteps.searchTabsOfTeams();
		Tools.backToMenu(2);
	}
	public void Competitions_160(){
		System.out.println("Verificare las estadisticas de una competicion");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapSoccerCompetition();
	...
	public void Competitions_170(){
		System.out.println("Voy a entrar en una competencia de motor y verificar los resultados");
		competitionsSteps.tapCompetitions();
	...
	public void Competitions_180(){//No se pudo realizar la verificacion del combobox solicitada en el documento de excel.
		System.out.println("Voy a verificar un resultado de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
		Tools.backToMenu(1);
	}
	public void Competitions_190(){
		System.out.println("Voy a verificar las noticias de una competencia de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
	...
	public void Competitions_200(){
		System.out.println("Voy a verificar las posiciones de una competencia de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
	...
	public void Competitions_210(){
		System.out.println("Voy a verificar el calendario de una competencia de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
	...
	public void Competitions_220(){//No se pudo realizar la verificacion del combobox solicitada en el documento de excel.
		System.out.println("Voy a verificar la funcionalidad del combobox desde el calendario de una competencia de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
		competitionsSteps.searchCalendarOfMotorCompetition();
		Tools.backToMenu(1);
	...
	public void Competitions_230(){
		System.out.println("Voy a verificar la seccion pilotos de una competencia de motor");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
	...
	public void Competitions_240(){//No se pudo realizar la verificacion del combobox solicitada en el documento de excel.
		System.out.println("Voy a verificar la funcionalidad del combobox desde la seccion pilotos");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapMotorCompetition();
		competitionsSteps.tapPilots();
		Tools.backToMenu(1);		
	...
	public void Competitions_250(){
		System.out.println("Voy a ingresar a una competencia de baseball y a buscar las posiciones");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapBaseballCompetition();
		Tools.backToMenu(1);
	}
	public void Competitions_260(){
		System.out.println("Voy a ingresar a una competencia de baseball y a buscar los resultados");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapBaseballCompetition();
	...
	public void Competitions_270(){
		System.out.println("Voy a ingresar a una competencia de baseball y a buscar las noticias");
		competitionsSteps.tapCompetitions();
		competitionsSteps.tapBaseballCompetition();
